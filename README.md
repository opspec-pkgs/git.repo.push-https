[![Build Status](https://github.com/opspec-pkgs/git.repo.push-https/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/git.repo.push-https/actions?query=workflow%3Abuild+branch%3Amain)
