[![build](https://github.com/opspec-pkgs/git.repo.push-https/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/git.repo.push-https/actions/workflows/build.yml)
